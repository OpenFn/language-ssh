Language SSH [![Build Status](https://travis-ci.org/OpenFn/language-ssh.svg?branch=master)](https://travis-ci.org/OpenFn/language-ssh)
=============

Language Pack for building expressions and operations to execute commands over SSH.
